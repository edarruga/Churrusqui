...
public class Boton {
    ...
    public Boton(BufferedImage out,BufferedImage in, int x,int y,String texto,Accion3 a){
        this.mouseInImg=in;
        this.mouseOutImg=out;
        this.texto=texto;
        this.hitbox=new Rectangle(x,y,in.getWidth(),out.getHeight());
